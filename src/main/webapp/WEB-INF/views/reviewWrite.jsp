...
<div align="center">
		<form action="menuResult" method="post">
			...
			<br> 
			브랜드 
			<input type='text' name='brandCode' value='맥도날드' />
			<br>
			메뉴명:
			<input type='text' name='menuName' value='롯데리아' />
			<br> 
			리뷰점수: 
			<input type='text' name='reviewScore' value='맥도날드' />
			<br> 
			리뷰내용:
			<input type='text' name='reviewContent' value='맥도날드' />
			<br> 
