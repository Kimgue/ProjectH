...
<script>
	function exchangeSubmit() {
		...
		alert("현재 포인트 : " + currentPoint);
		alert("필요 포인트 : " + gifticonPoint);
	...
	<div id="content">
		<c:choose>
			<c:when test="${not empty gifticonList}">
				<form id="gifticonExchangeSubmit" action="gifticonExchangeSubmit" method="post">
				...
				<input type="button" value="교환" onclick="exchangeSubmit()">
			</c:when>
